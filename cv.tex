...
\begin{itemize}
    \item Assessing candidate technical work in AI safety, ML, DL.
\end{itemize}

\textbf{MATS - Research Manager}
\hfill {May 2025 - Nov 2025}
\begin{itemize}
    \item Supporting MATS research projects with a focus on evaluations and control research tracks (UK AISI \& GDM).
\end{itemize}

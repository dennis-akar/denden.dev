...
\textbf{ARENA - Technical Evaluator}
\hfill {Nov 2025 - Present}
\begin{itemize}
    \item Assessing candidate technical work in ML, DL, and AI safety.
\end{itemize}

\textbf{MATS - Research Manager}
\hfill {May 2025 - Nov 2025}
\begin{itemize}
    \item Supporting MATS research projects with a focus on evaluations and control research tracks
    \item Google DeepMind: Mary Phuong; UK AISI: Tomek Korbak \& Sid Black.
\end{itemize}

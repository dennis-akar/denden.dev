...
\begin{itemize}
    \item Investigating behaviour modelling, capability separability, and using mechinterp methods for training and fine-tuning to improve safety in LLMs.
\end{itemize}
...
\begin{itemize}
    ...
    \item Proposed and implemented the gated attention block, resolving attention head superposition with the aim of making it easier to study individual attention heads.
